<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:53:"C:\wamp\www\tp5\admin\index\view\users\admin_add.html";i:1463823219;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<link rel="stylesheet" type="text/css" href="/static/admin/lib/h-ui/skin/default/skin.css" id="skin" />
<link rel="stylesheet" type="text/css" href="/static/admin/lib/h-ui/css/style.css" />
<!--[if IE 6]>
...
<article class="page-container">
	<form class="form form-horizontal" action="<?php echo U('Users/admin_add_user'); ?>" method="post" id="form-admin-add">
	<div class="row cl">
