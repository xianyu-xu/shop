<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"C:\wamp\www\tp5\jzshop.git\trunk\admin\index\view\users\admin_role_add.html";i:1463916473;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
	<form action="<?php echo U('Index/users/admin_role_add_user'); ?>" method="post" class="form form-horizontal" id="form-admin-role-add">
		<div class="row cl">
