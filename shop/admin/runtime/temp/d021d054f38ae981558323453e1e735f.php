<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"C:\wamp\www\tp5\jzshop.git\trunk\admin\index\view\goods\product_edit.html";i:1463718011;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
	<form action="<?php echo U('Goods/product_edit_save'); ?>" method="post" class="form form-horizontal" id="form-article-add">
		<div class="form-group">
			<label  for="inputEmail3" class="col-sm-2 control-label"><span class="c-red">*</span>商品标题：</label>
			<div class="col-xs-8 col-sm-9">
				<input type="text" class="form-control" value="<?php echo $goods['goodsname']; ?>" placeholder="" id="" name="goodsname">
		...
		<div class="form-group">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="form-control" size="1" name="tid">
		            ...
		            <option value="<?php echo $vo['id']; ?>,<?php echo $vo['pid']; ?>"  <?php if(($goods['tid'] == $vo['id'])): ?> selected <?php endif; ?> ><?php echo $vo['level']; ?>级分类&nbsp;<?php echo $vo['name']; ?></option>
		...
		<div class="form-group">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
					...
					<input type="radio" id="checkbox-1" name="attributes" value="1" <?php if(($goods['attributes'] == 1)): ?> checked <?php endif; ?>>
					</label>
				
			
					<label for="checkbox-inline">2、新上
					<input type="radio" id="checkbox-1" name="attributes" value="2" <?php if(($goods['attributes'] == 2)): ?> checked <?php endif; ?>>
					</label>
			
			
					<label for="checkbox-1">3、热卖</label>
					<input type="radio" id="checkbox-1" name="attributes" value="3" <?php if(($goods['attributes'] == 3)): ?> checked <?php endif; ?>>
					
		
				
					<label for="checkbox-1">4、促销</label>
					<input type="radio" id="checkbox-1" name="attributes" value="4" <?php if(($goods['attributes'] == 4)): ?> checked <?php endif; ?>>
					
			
				
					<label for="checkbox-1">5、包邮</label>
					<input type="radio" id="checkbox-1" name="attributes" value="5" <?php if(($goods['attributes'] == 5)): ?> checked <?php endif; ?>>
					
			
			
					<label for="checkbox-1">6、限时卖</label>
					<input type="radio" id="checkbox-1" name="attributes" value="6" <?php if(($goods['attributes'] == 6)): ?> checked <?php endif; ?>>
			
			
					<label for="checkbox-1">7、不参与会员折扣</label>
					<input type="radio" id="checkbox-1" name="attributes" value="7" <?php if(($goods['attributes'] == 7)): ?> checked <?php endif; ?>>
		...
		<div class="form-group">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="unit" id="" placeholder="输入单位" value="<?php echo $goods['unit']; ?>" class="form-control" style=" width:25%">	如/个/件
		...
		<div class="form-group">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="number" id="" placeholder="输入数字" value="<?php echo $goods['number']; ?>" class="form-control" style=" width:25%">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">条形码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="barcode" id="" placeholder="输入数字" value="<?php echo $goods['barcode']; ?>" class="form-control" style=" width:25%">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="curprice" id="" placeholder="输入数字" value="<?php echo $goods['curprice']; ?>" class="form-control" style=" width:25%">
				元</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">市场价格：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="oriprice" id="" placeholder="输入数字" value="<?php echo $goods['oriprice']; ?>" class="form-control" style=" width:25%">
				元</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">成本价格：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="cosprice" id="" placeholder="输入数字" value="<?php echo $goods['cosprice']; ?>" class="form-control" style=" width:25%">
				元</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">库存量：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="inventory" id="" placeholder="输入数字" value="<?php echo $goods['inventory']; ?>" class="form-control" style=" width:25%">
				件</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">限制购买量：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="restrict" id="datemin" placeholder="输入数字" class="form-control Wdate" value="<?php echo $goods['restrict']; ?>" style=" width:25%">
			件</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">已经购买量：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="already" id="datemax" placeholder="输入数字"  class="form-control Wdate" style=" width:25%" value="<?php echo $goods['already']; ?>">
			件</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">运费：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="freight" id="" value="<?php echo $goods['freight']; ?>"  placeholder="输入数字" class="form-control" style=" width:25%" value="<?php echo $goods['freight']; ?>">
			元</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">是否上架：</label>
					...
					<input type="radio" id="checkbox-1" name="status" value="0" <?php if(($goods['status'] == 0)): ?> checked <?php endif; ?>>
					
				
				
					<label for="checkbox-1">下架</label>
					<input type="radio" id="checkbox-1" name="status" value="1" <?php if(($goods['status'] == 1)): ?> checked <?php endif; ?>>
		...
		<div class="form-group">
			...
			<div class="formControls col-xs-2 col-sm-2">
				<input type="text" class="form-control" value="<?php echo $goods['reorder']; ?>" placeholder="" id="" name="reorder">
		...
		<div class="form-group">
			...
			<?php foreach($image as $v): ?>
						<div class="input-group " id="imageDelete<?php echo $v['id']; ?>" style="margin-top:.5em;margin-right:2em; float:left;"><input type="hidden" name="imagepath[]" class="imagepath" value="<?php echo $v['id']; ?>"/><img src="<?php echo $v['filepath']; ?>"; class="img-responsive img-thumbnail" width="150"><a class="close" style="position:absolute; top: 0px; right: -14px;" title="删除这张图片" onclick="deleteImage('<?php echo $v['id']; ?>')">×</a></div>
